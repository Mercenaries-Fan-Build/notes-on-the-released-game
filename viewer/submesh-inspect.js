/**
 * Submesh / mesh utility helpers (no class — all state lives in main.js).
 * Ported from mercs2_preview.html for rendering parity.
 */
...
/** Intact vs damaged / switch side 0 vs 1 — not LOD. When showBoth is true, all variants pass. */
